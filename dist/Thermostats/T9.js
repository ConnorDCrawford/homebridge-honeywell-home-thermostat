...
class T9 {
    constructor(platform, accessory, locationId, device, firmware) {
        ...
        this.removeHoldService = accessory.getServiceById(this.platform.Service.Switch, 'remove_hold_switch') ||
            this.accessory.addService(this.platform.Service.Switch, `${this.device.name} ${this.device.deviceClass} Remove Hold`, 'remove_hold_switch');
    ...
    updateHomeKitCharacteristics() {
        ...
        this.removeHoldService.updateCharacteristic(this.platform.Characteristic.On, this.noHoldSetpointStatusMode === this.SetpointStatus);
    }
    ...
    setSetpointStatus(value, callback) {
    ...
    setSetpointNoHoldStatus(value, callback) {
        if (value) {
